...
public class PropertyService {
    ...
    public PropertyModel getPropertyById(final Long propertyId, final Long addressId) {
    ...
    public PropertyModel getPropertyByIdAndAddressId(Long propertyId, Long addressId) {
        return null;
    }
}
